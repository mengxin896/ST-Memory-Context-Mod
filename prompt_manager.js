...
(function () {
    ...
    const PROMPT_VERSION = 5.8;         // 提示词版本号
...
- 人物档案:记录新登场角色.若角色已存在表格,根据剧情的发展和时间的推移仅使用updateRow更新其[年龄(根据初始设定及剧情时间推移更新年龄,无确定年龄根据首次出场或人物背景关系推测并确定年龄)]、[外貌(简要描述角色的外貌特征,如发色、瞳色、体型等)]、[身份(该身份仅记录社会身份,如职业)]、[地点]或[性格/备注].
...
✅ 新增人物档案:
<Memory><!-- insertRow(3, {0: "艾莉娅", 1: "23岁", 2: "银色长发,紫色瞳孔,身材纤细", 3: "神秘商人", 4: "迷雾森林", 5: "神秘冷静,知识渊博", 6: "有一个失散的妹妹,擅长占卜"})--></Memory>
